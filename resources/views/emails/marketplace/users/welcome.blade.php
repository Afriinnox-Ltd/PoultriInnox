...
@section('content')
    ...
    <p>Visit our <a href="{{ config('app.url') }}/help" style="color: #39512A;">Help Center</a> or contact our support team
        at <a href="mailto:support@agriinnox.com" style="color: #39512A;">support@agriinnox.com</a></p>
