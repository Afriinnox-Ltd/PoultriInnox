...
@section('content')
    ...
    <h3>Get Started with Your Vendor Dashboard</h3>
    ...
    <ol style="color: #4b5563; line-height: 1.8;">
        ...
        <li>Review our <a href="{{ config('app.url') }}/vendor-guidelines" style="color: #39512A;">Vendor Guidelines</a>
        </li>
    </ol>

    <p><strong>Need help getting started?</strong></p>
    <p>Check out our <a href="{{ config('app.url') }}/vendor-guide" style="color: #39512A;">Vendor Success Guide</a> or
        contact us at <a href="mailto:vendors@agriinnox.com" style="color: #39512A;">vendors@agriinnox.com</a></p>
