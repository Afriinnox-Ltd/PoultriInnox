...
export default function VendorOrdersPage({ orders, filters, stats, user_type }: VendorOrdersPageProps) {
    ...
    const handleSearch = () => {
        ...
        window.location.href = `/vendor/orders?${params.toString()}`;
    };
    ...
    const printOrder = (order: any) => {
        ...
        const printContent = `
            ...
            <html>
            <head>
                <title>Vendor Order #${order.order_number}</title>
                <style>
                    body {
            ...
            <body>
                <div class="header">
                    <div class="company-name">Vendor Order Details</div>
                                                ...
                                                <div className="bg-blue-50 p-4 rounded-lg mb-4">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                                                        ...
                                                        {order.shipping.estimated_delivery && (
                                                            <div>
                                                                <span className="font-medium">Est. Delivery:</span> {formatDate(order.shipping.estimated_delivery)}
                                                            </div>
                                                        )}
                                                    </div>
                                                </div>
                                        ...
                                        <div className="flex gap-2 flex-wrap">
                                            ...
                                            {(order.status === 'shipped' || order.status === 'processing') && (
                                                <Button
                                                    size="sm"
                                                    variant="outline"
                                                    onClick={() => window.location.href = `/vendor/orders/${order.id}/shipping`}
                                                >
