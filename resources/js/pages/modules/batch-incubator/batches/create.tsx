...
import { ArrowLeft, Egg, AlertTriangle } from 'lucide-react';
        ...
        <AppLayout>
            ...
            <div className="space-y-6  flex justify-center items-center flex-col ">
                ...
                <Alert className="max-w-2xl">
                    ...
                    <AlertTitle>Important: Batch Deletion Policy</AlertTitle>
                    <AlertDescription>
                        Once a batch has events, bird counts, or financial data recorded, it cannot be deleted.
                        Only empty batches in "planned" status can be removed. Please ensure batch details are correct before proceeding.
                    </AlertDescription>
                </Alert>

                <Card className="lg:max-w-2xl w-full">
                    <CardHeader>
