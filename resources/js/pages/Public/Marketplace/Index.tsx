                    ...
                    <div className="max-w-4xl mx-auto" ref={searchRef}>
                        <div className="relative">
                            <div className="flex items-center ">
                                <select
                                    className="px-4 py-2 border border-r-0 border-gray-300 rounded-l-md bg-gray-50 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
                                ...
                                <div className="flex-1 relative">
                                    <Input
                                        ...
                                        className="w-full px-4 rounded-l-none py-3 border border-gray-300 focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                                    />
                                ...
                                <Button
                                    ...
                                    className="bg-emerald-600 ml-3 hover:bg-emerald-700 text-white font-semibold px-8 py-3 rounded-r-md"
                                >
                                    Search
                                </Button>
                            </div>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center justify-between">
                        <p className="text-sm text-gray-700">
                            Enjoy reliability, secure online ordering and a free returns policy.
                        </p>
                        <Link variant="outline" size="sm" className="border-gray-300 border rounded-lg px-4 py-1" href="/store/search">
                            Start here
                        </Link>
                    </div>
                </div>
