...
const CreateMedicationProtocol: React.FC = () => {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        post('/admin/smart-scheduling/protocols/medication');
    };
    ...
    return (
        <AdminLayout>
            <Head title="Create Medication Protocol" />
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">Create Medication Protocol</h1>
                            <p className="text-gray-600">Add a new medication protocol to the system</p>
                        </div>
                    </div>
                </div>
...
export default CreateMedicationProtocol;
