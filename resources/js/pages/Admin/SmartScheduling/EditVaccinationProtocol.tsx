...
interface EditVaccinationProtocolProps {
    protocol: VaccinationProtocol;
}

const EditVaccinationProtocol: React.FC<EditVaccinationProtocolProps> = ({ protocol }) => {
    const { data, setData, put, processing, errors } = useForm<FormData>({
        ...
        recommended_age_days: protocol.recommended_age_days || 7,
        administration_method: protocol.administration_method || '',
        dosage_amount: protocol.dosage_amount || 0,
        dosage_unit: protocol.dosage_unit || 'ml',
        booster_required: protocol.booster_required || false,
        booster_interval_days: protocol.booster_interval_days || 0,
        storage_temperature_min: protocol.storage_temperature_min || 2,
        storage_temperature_max: protocol.storage_temperature_max || 8,
        cost_per_dose: protocol.cost_per_dose || 0,
        manufacturer: protocol.manufacturer || '',
        priority_level: protocol.priority_level || 'medium',
        is_mandatory: protocol.is_mandatory || false,
    ...
    const handleSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        put(`/admin/smart-scheduling/protocols/vaccination/${protocol.id}`);
    };
    ...
    return (
        <AdminLayout>
            <Head title={`Edit ${protocol.vaccine_name}`} />
            ...
            <div className="space-y-6">
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h1 className="text-2xl font-bold text-gray-900">Edit Vaccination Protocol</h1>
                            <p className="text-gray-600">{protocol.vaccine_name}</p>
                        </div>
                    </div>
                </div>
...
export default EditVaccinationProtocol;
