...
export default function Create({ users }: Props) {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        post('/admin/marketplace/vendors', {
            forceFormData: true,
            onSuccess: () => toast.success('Vendor created successfully'),
                ...
                <div className="flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-muted-foreground text-sm">Register a new vendor account</p>
                        </div>
                    </div>
                    <Button type="submit" disabled={processing}>
                        <Save className="h-4 w-4 mr-1" /> {processing ? 'Creating...' : 'Create Vendor'}
                    </Button>
                </div>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        <Select value={data.user_id} onValueChange={handleUserSelect}>
                                            <SelectTrigger>
                                                <SelectValue placeholder="Select a user without a vendor account" />
                                            </SelectTrigger>
                                            <SelectContent>
                                                <div className="p-2">
                                                    <Input
                                        ...
                                        {selectedUser && (
                                            <p className="text-xs text-muted-foreground mt-1">Selected: {selectedUser.name} &mdash; {selectedUser.email}</p>
                                        )}
                                    </div>
                                    ...
                                    <div className="flex flex-col items-center gap-3">
                                        {logoPreview && (
                                            <div className="relative">
                                                <img src={logoPreview} alt="Logo preview" className="h-32 w-32 rounded-full object-cover border" />
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div>
                                        ...
                                        {errors.business_phone && <p className="text-sm text-destructive mt-1">{errors.business_phone}</p>}
                                    </div>
                                    <div>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    <div>
                                        ...
                                        {errors.business_address && <p className="text-sm text-destructive mt-1">{errors.business_address}</p>}
                                    </div>
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                            ...
                            <Card>
                                ...
                                <CardContent className="space-y-4">
                                    <div>
                                        ...
                                        <p className="text-xs text-muted-foreground mt-1">Select "Approved" to auto-approve the vendor immediately</p>
                                    </div>
