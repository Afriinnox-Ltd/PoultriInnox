...
class DashboardController extends Controller
{
    ...
    public function index()
    {
        ...
        // Only load BatchIncubator data if the module is enabled
        if ($user->hasModule('batch-incubator')) {
            $dashboardData = array_merge($dashboardData, $this->getBatchIncubatorData());
        }
    ...
    /**
     * Get BatchIncubator specific dashboard data
     */
    private function getBatchIncubatorData()
    {
