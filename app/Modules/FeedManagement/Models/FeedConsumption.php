...
class FeedConsumption extends Model
{
    ...
    protected $casts = [
        ...
        'average_bird_weight' => 'decimal:1',
        'weight_gain' => 'decimal:1',
        'fcr' => 'decimal:3',
        'cumulative_fcr' => 'decimal:3',
        'feed_cost_per_unit' => 'decimal:2',
        'total_feed_cost' => 'decimal:2',
        'cost_per_bird' => 'decimal:2',
        'temperature' => 'decimal:1',
        'humidity' => 'decimal:1',
        'feeding_efficiency' => 'decimal:2',
