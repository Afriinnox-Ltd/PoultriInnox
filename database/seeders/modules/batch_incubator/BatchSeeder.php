    ...
    public function run(): void
    {
        ...
        $batches = [
            [
                ...
                'initial_cost' => 2850000.0, // 2.85M RWF (3,000 RWF per chick)
            ...
            [
                ...
                'initial_cost' => 3600000.0, // 3.6M RWF (6,000 RWF per layer chick)
                'feed_cost' => 4720000.0, // 4.72M RWF
                'medication_cost' => 360000.0, // 360K RWF
                'other_costs' => 590000.0, // 590K RWF
                'revenue' => 10620000.0, // 10.62M RWF (35400 eggs * 300 RWF)
                'batch_data' => [
            ...
            [
                ...
                'total_eggs_produced' => 0,
                'avg_daily_production' => 0,
                'initial_cost' => 3600000.0, // 3.6M RWF (3,000 RWF per egg)
                'feed_cost' => 0, // No feed yet
                'medication_cost' => 0,
                'other_costs' => 120000.0, // 120K RWF - Incubation costs
                'revenue' => 0,
                'batch_data' => [
            ...
            [
                ...
                'total_eggs_produced' => 0,
                'avg_daily_production' => 0,
                'initial_cost' => 2500000.0, // 2.5M RWF (5,000 RWF per heritage breed egg)
                'feed_cost' => 0,
                'medication_cost' => 0,
                'other_costs' => 0,
                'revenue' => 0,
